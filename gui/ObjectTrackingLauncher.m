classdef ObjectTrackingLauncher < handle
    ...
    methods
        function this = ObjectTrackingLauncher(this)
            ...
            set(this.handles.pushbutton_playiterate,'callback', @this.pushbutton_playiterate_callback);
        ...
        function pushbutton_open_callback(this, varargin)
            ...
            if ~isequal(this.filename,0)
                ...
                this.frame_height_margin = size(this.current_frame, 1) - this.margin;
                this.frame_width_margin = size(this.current_frame, 2) - this.margin;
            end
